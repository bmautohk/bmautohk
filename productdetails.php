      ...
      -->        
		...
		?>
          ...
          <td width="628">          	    
                ...
                <td colspan="2">
                  <table cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
					  ...
					  ?>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">商品番号</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_cd']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">商品名</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_name']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">車種</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_made']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">適合車型</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_car_name']." ".$rowresult['product_model']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">製品類別</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_cat']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">製品カラー</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_colour']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">ピース</td>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="528"><?php echo $rowresult['product_qty']; ?></td>
                      <td class="verticalborder" width="1"></td>
                    </tr>
                    <tr>
				  	  <td class="horizontalborder" colspan="5"width="628" height="1"></td>
            ...
            <?php include_once("yahoo_adv2.php");?>    
          </td>
        </tr>
      </table>
