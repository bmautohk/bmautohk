...
<table cellspacing="0" cellpadding="0" width="748" border="0" align="center">
        <tbody><tr>
          <td align="center"><input type="submit" name="showby" value="By Category"/></td><td align="center"><input type="submit" name="showby" value="By Model"/></td><td align="center"><input type="submit" name="showby" value="By Product"/></td>
          </tr>
          <tr>
          <td colspan="3" align="center">
		  <div class="scroll"style="width:732px"><?php include_once("productdesc.php");?>
		  </div>
          </td>
