...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td colspan="2">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0"bgcolor="#000000">
        ...
        <tr>
          ...
          <td align="left" rowspan="2" width="30%" height="80"><font color="white"><?php  echo "Hi {$auth->getUserName()}";  ?></font><a href="logout.php">[Logout]</a></td>
  ...
  <tr>    
    <td align="center" valign="top" width="14%">
      <table cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" width="240">  
        <tbody> 
        <tr>
        ...
        <tr>
          <td colspan="3" align="right"><img src="../images/toyota.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>
        <tr>
          <td colspan="3" align="right"><img src="../images/honda.gif" /></td>
        </tr>        
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/nissan.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/suzuki.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/mitsubishi.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/subaru.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/mazada.gif" /></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>  
        <tr>
          <td colspan="3" align="right"><img src="../images/daihatsu.gif" /></td>
        </tr>
      </tbody></table>
    </td>
    <td width="80%">b</td>
