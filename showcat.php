...
if ($i % 2 == 1) {
		echo "<tr>
			    ...
			    <a href=\"product.php?productcat=".$row['product_cat']."\"><img src='images/product/".$row['product_cd']."_s.jpg'></a></td>
			<td width='200'></td>
			<td width='200'></td>";
	...
	elseif ($i % 2 == 0){
		echo "<td width='2%'></td>
		  	  <td><img src='images/category/".strtolower($str).".jpg'><br><a href=\"product.php?productcat=".$row['product_cat']."\"><img src='images/product/".$row['product_cd']."_s.jpg'></a></td>		  		
			  </tr>";
