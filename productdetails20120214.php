                ...
                <td colspan="2">
                  <table cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
					  ...
					  ?>
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">商品編號</td>
                      <td class="verticalborder" width="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">適合型號</td>
                      <td class="verticalborder" width="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">產品類別</td>
                      <td class="verticalborder" width="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">產品顏色</td>
                      <td class="verticalborder" width="1"></td>
                    ...
                    <tr>                     
                      <td class="verticalborder" width="1"></td>
                      <td class="productdetailitem" width="100" height="30">產品數量</td>
                      <td class="verticalborder" width="1"></td>
